...
final class Timer
{
    ...
    /**
     * @param float|null $beep Seconds
     * @param \Closure(): bool|null $condition Condition to stop waiting
     */
    ...
    {
        return ! $this->stop && null !== $this->beep && $this->elapsed() > $this->beep
            or null !== $this->condition && true === ($this->condition)();
    }
