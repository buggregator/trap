...
class Message extends \Google\Protobuf\Internal\Message
{
     ...
     * @var string $command
     * @var string $payload
     * @var array<\Buggregator\Trap\Test\Proto\Message\Metadata>|\Google\Protobuf\Internal\RepeatedField $main_metadata
     * @var int $foo
     * @var bool $is_foo
     * @var string $data
     * @var Message\Metadata $metadata
     * @var Message\Header $header
     * @var array|\Google\Protobuf\Internal\MapField $mapa_mapa
     *                                               }
     */
